...
const WeatherMain = () => {
  ...
  const [routes] = React.useState([
    { key: 'home1', title: 'Lahnstein', icon: 'paw', unfocusedIcon: 'heart-outline', color:'#ded831', customName: "Lahnstein", coordinates: "50.307827,7.609363"},
    { key: 'home2', title: 'Elz', icon: 'school', color: 'red', customName: "Elz", coordinates: "50.4166700,8.0333300"},
